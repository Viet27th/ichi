...
var axiosInstance = function axiosInstance(req) {
  ...
  axiosInstance.interceptors.request.use(function (config) {
    ...
    var userProfile = _cookie_service__WEBPACK_IMPORTED_MODULE_3__["default"].verifyJWT(token); // Token is expired in 7 days, before that 1 day, we will refresh token if user still working on my system.
    // If user doesn't on my system in 7 days, next time visiting must be login

    if (userProfile && typeof window !== 'undefined') {
      if (userProfile.expMillisecond - _babel_runtime_corejs2_core_js_date_now__WEBPACK_IMPORTED_MODULE_1___default()() < 24 * 60 * 60 * 1000) {
        axios__WEBPACK_IMPORTED_MODULE_2___default.a.post(_express_api_service__WEBPACK_IMPORTED_MODULE_7__["express_api"].webRefreshTokenTraditionalUrl).then(function (result) {
          // Set cookie client
...
//# sourceMappingURL=create-post.js.6d350fbf0920311c3cb3.hot-update.js.map