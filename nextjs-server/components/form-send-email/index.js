...
export class FormSendEmailComponent extends React.Component {
  render () {
    return (
      <div id="container">
        <h1 className="mt-2">&bull; Đặt hàng &bull;</h1>
        ...
        <form action="#" method="post" id="contact_form">
          <div className="name">
            ...
            <input type="text" placeholder="Họ tên" name="name" id="name_input" required />
          </div>
          <div className="email">
          ...
          <div className="message">
            ...
            <textarea name="message" placeholder="Để lại thông tin mặt hàng và chúng tôi sẽ liên lạc với bạn. Cảm ơn!!!" id="message_input" cols="30" rows="5" required></textarea>
          </div>
          <div className="submit">
            <button id="form_button" type="button" data-dismiss="modal">Gửi đi</button>
          </div>
        </form>
